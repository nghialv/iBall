...
#define DEVICE_TYPE_IPAD_RETINA 6
...
static float DEVICES_WIDTH[] = {320, 768, 320, 320, 320, 768, 1536};
static float DEVICES_HEIGHT[] = {480, 1024, 480, 480, 568, 1024, 2048};
static float DEVICES_RATIO[] = {RATIO_K/163.0, RATIO_K/163.0, RATIO_K/163.0, RATIO_K/163.0, RATIO_K/163.0, RATIO_K/132.0, RATIO_K/264.0};
